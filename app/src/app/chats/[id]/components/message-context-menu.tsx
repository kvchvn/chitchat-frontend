...
export function MessageContextMenu({ parentRef }: MessageContextMenuProps) {
  ...
  if (!session || !socket || !message || !isOpen) {
    return null;
  }

  const handleRemoveMessage = () => {
    socket.emit('message:remove', { chatId: message.chatId, messageId: message.id });
    closeContextMenu();
  };
